:page-description: This page describes steps during the board and officer election.
...
In 2023, the election committee consists of link:https://www.jenkins.io/blog/authors/notmyfault/[Alexander Brandes] and link:https://www.jenkins.io/blog/authors/uhafner/[Ullrich Hafner].
