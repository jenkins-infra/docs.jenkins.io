...
* Team Leads are appointed by the xref:project:governance-meeting:index.adoc[Jenkins Governance Meeting] after nomination in the Jenkins developer mailing list.
...
* Jenkins Officer is an *elected role*.
  Officers are elected by the Jenkins community during the regular xref:project:ROOT:board-election-process.adoc[Jenkins elections].
...
* Facilitating initiatives within the scope of the responsibility, maintaining the team's roadmap,
  and ensuring that key team initiatives reflected on the link:https://www.jenkins.io/project/roadmap/[public Jenkins roadmap].
...
* Represent the xref:security:ROOT:cna.adoc[Jenkins CNA].
...
* Coordinate Jenkins Infrastructure initiatives and define priorities, get key initiatives reflected on the link:https://www.jenkins.io/project/roadmap/[public Jenkins roadmap]
...
.References
****
* xref:project:ROOT:board-election-process.adoc[Jenkins Governance Board and Officer election process]
****