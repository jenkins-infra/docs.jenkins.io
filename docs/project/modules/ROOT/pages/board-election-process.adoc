...
This document outlines the xref:project:ROOT:governance.adoc#governance-board[Jenkins Governance Board] and xref:project:ROOT:team-leads.adoc[Jenkins officer] election process.
...
More contributors might be added to the election committee if approved by the xref:project:governance-meeting:index.adoc[regular governance meeting].
...
** link:https://www.jenkins.io/blog/authors/kohsuke[Kohsuke] holds a permanent board seat until such a time he decides to resign.
** Four members are elected.
If link:https://www.jenkins.io/blog/authors/kohsuke[Kohsuke] decides to resign, all five members will be elected.
...
* If a board member gets employed by a company and the limitation gets violated, somebody must step down and the board will follow the xref:#interim-procedures[Interim Procedures]
...
The decision may be escalated to the xref:project:governance-meeting:index.adoc[Jenkins governance meeting] and overridden by voting there.
...
The candidates should also provide their statements, list of affiliations (see xref:#corporate-disclosure[Corporate Disclosure]), any account/social media links which may help voters to get more information about them, and plans if they are elected to the role.
...
Every contributor can vote only once, and multiple intentional votes will be considered a violation and serious misbehavior, subject to the xref:project:ROOT:conduct.adoc[Jenkins Code of Conduct].
...
If a board member resigns, the board is allowed to appoint an interim board member to fulfill the remainder of the term, subject to approval in a regular xref:project:governance-meeting:index.adoc[governance meeting].
...
* 2022 - link:https://www.jenkins.io/blog/2022/10/20/jenkins-election-announcement/[announcement]
...
* All xref:project:ROOT:team-leads.adoc[officer positions] will be voted on in 2019 and then in 2020.
...
link:https://www.jenkins.io/blog/authors/kohsuke[Kohsuke] holding a permanent board seat until such a time he decides to resign.

Related decisions:

* xref:project:ROOT:conduct.adoc[Jenkins Code of Conduct] is accepted and published.
