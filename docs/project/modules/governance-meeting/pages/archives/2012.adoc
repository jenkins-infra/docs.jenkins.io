= Jenkins Governance Meeting Archive 2012
...
(lisawells)]/link:https://www.jenkins.io/blog/authors/kohsuke/[
(kohsuke)])
...
(link:https://www.jenkins.io/blog/authors/ndeloof[(ndeloof)])
...
FOSDEM conferences (link:https://www.jenkins.io/blog/authors/rtyler/[
(rtyler)])
...
Election Process] (link:https://www.jenkins.io/blog/authors/kohsuke/[
(kohsuke)])
...
manage restart. (link:https://www.jenkins.io/blog/authors/ndeloof[
(ndeloof)])
...
Plugin]) (link:https://www.jenkins.io/blog/authors/rtyler/[
(rtyler)])
...
((ikikko),
link:https://www.jenkins.io/blog/authors/kohsuke/[(kohsuke)], and
others)
...
* Recap last meeting's action items
* Please sign CLAs (link:https://www.jenkins.io/blog/authors/kohsuke/[(kohsuke)])
* Officially launching
https://wiki.jenkins.io/display/JENKINS/Jenkins+CIA+Program[Jenkins CIA
Program] (link:https://www.jenkins.io/blog/authors/kohsuke/[
(kohsuke)])
* "Jenkins@cloud for GitHub" and "Jenkins@cloud by CloudBees" name usage
approval (link:https://www.jenkins.io/blog/authors/kohsuke/[
(kohsuke)])
...
for the community site (link:https://www.jenkins.io/blog/authors/rtyler/[(rtyler)])
