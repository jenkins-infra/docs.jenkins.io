...
Election Process] (link:https://www.jenkins.io/blog/authors/rtyler/[
(rtyler)])
* Review/adopt a
...
(link:https://www.jenkins.io/blog/authors/batmat[(batmat)]) (for
...
Walding] (link:https://www.jenkins.io/blog/authors/daniel-beck/[
(danielbeck)])
* Review
https://wiki.jenkins.io/display/JENKINS/Board+Election+Process[Board
...
- Project sub-teams] (link:https://www.jenkins.io/blog/authors/rtyler/[(rtyler)])
...
program] messages (link:https://www.jenkins.io/blog/authors/daniel-beck/[(danielbeck)])
...
link:https://www.jenkins.io/blog/authors/orrc[(orrc)]
...
(oleg_nenashev)],
(vlatombe) and
(varmenise) (link:https://www.jenkins.io/blog/authors/oleg_nenashev/[(oleg_nenashev)])
...
program] messages (link:https://www.jenkins.io/blog/authors/daniel-beck/[(danielbeck)])
* JUC travel grant (link:https://www.jenkins.io/blog/authors/daniel-beck/[(danielbeck)])
...
points of failure]? (link:https://www.jenkins.io/blog/authors/orrc[
(orrc)])
...
without wiki pages]? (link:https://www.jenkins.io/blog/authors/orrc[
(orrc)])
...
(link:https://www.jenkins.io/blog/authors/olivergondza[
(olivergondza)])
* #jenkins-meeting (link:https://www.jenkins.io/blog/authors/daniel-beck/[(danielbeck)])
* Should we only include plugins in the Update Centre if they have a
wiki page? (link:https://www.jenkins.io/blog/authors/orrc[(orrc)],
(evernat)
...
center (link:https://www.jenkins.io/blog/authors/daniel-beck/[
(danielbeck)])
...
discussion]
* #jenkins-meeting (link:https://www.jenkins.io/blog/authors/daniel-beck/[(danielbeck)])
* LTS.next (link:https://www.jenkins.io/blog/authors/olivergondza[
(olivergondza)])
* Infra training? (Was mentioned a while back and more recently, but
can't find the link) (link:https://www.jenkins.io/blog/authors/orrc[
(orrc)])
* Using a CDN with HTTPS / removing need for mirrorbrain?
(link:https://www.jenkins.io/blog/authors/orrc[(orrc)])
** https://issues.jenkins.io/browse/INFRA-266?focusedCommentId=226524#comment-226524[Comments
...
by the community (link:https://www.jenkins.io/blog/authors/ndeloof[
(ndeloof)])
...
shown in 2015. (link:https://www.jenkins.io/blog/authors/orrc[
(orrc)])
...
(discussed by link:https://www.jenkins.io/blog/authors/kohsuke/[
(kohsuke)], link:https://www.jenkins.io/blog/authors/jglick[
(jglick)] & link:https://www.jenkins.io/blog/authors/daniel-beck/[
(danielbeck)] in IRC)
...
list discussion] (link:https://www.jenkins.io/blog/authors/orrc[
(orrc)])
...
* LTS RC status (link:https://www.jenkins.io/blog/authors/kohsuke/[
...
* JUC post-mortem (link:https://www.jenkins.io/blog/authors/alyssat[
(atong)]/link:https://www.jenkins.io/blog/authors/kohsuke/[
(kohsuke)])
