= Jenkins Governance Meeting Archive 2013
...
* LTS status (link:https://www.jenkins.io/blog/authors/jglick[
(jglick)])
...
(domi)
* Travel grant to JUC (link:https://www.jenkins.io/blog/authors/kohsuke/[(kohsuke)]) 
MINUTES
