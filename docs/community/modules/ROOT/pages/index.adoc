...
Please contact us in the https://app.gitter.im/#/room/#jenkinsci_newcomer-contributors:gitter.im[Newcomer] or https://app.gitter.im/#/room/#jenkinsci_advocacy-and-outreach-sig:gitter.im[Advocacy and Outreach SIG] Gitter channels if you have any questions about contributing to Jenkins.

See the https://www.youtube.com/playlist?list=PLN7ajX_VdyaMsvHNW5JGlGdgJzqJ7Q5Mr[Contributing to Jenkins YouTube playlist] for deep dives into specific areas.
