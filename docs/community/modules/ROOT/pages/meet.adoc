...
We publish events on the xref:events:ROOT:index.adoc[Events page] and in our xref:events:ROOT:index.adoc#event-calendar[event calendar], but not all events are listed there.
...
xref:events:contributor-summit:index.adoc[contributor summits].
We also participate in conferences like xref:events:fosdem:index.adoc[FOSDEM] or link:https://events.linuxfoundation.org/cdcon/[cdCon],
