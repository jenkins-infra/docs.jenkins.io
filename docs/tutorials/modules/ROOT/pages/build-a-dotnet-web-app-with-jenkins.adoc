...
include::tutorials/_new_prerequisites.adoc[]
...
Read more about Pipeline and what a Jenkinsfile is in the xref:pipeline:index.adoc[Pipeline] and xref:pipeline:jenkinsfile.adoc[Using a Jenkinsfile] sections of the User Handbook.
...
[.boxshadow]
image::tutorials/dotnet/initial-pipeline.png[Initial Pipeline Success,width=100%]
...
[.boxshadow]
image::tutorials/dotnet/first-build-details.png[Initial Pipeline first run details,width=100%]
In the left navigation pane, you can select *Pipeline Overview* to see the stages of the Pipeline.
[.boxshadow]
image::tutorials/dotnet/pipeline-overview.png[Initial Pipeline runs successfully,width=100%]
...
[.boxshadow]
image::tutorials/dotnet/build-stage-overview.png[Build stage overview,width=100%]
...
[.boxshadow]
image::tutorials/dotnet/test-stage-added.png[Test stage runs successfully,width=100%]
...
[.boxshadow]
image::tutorials/dotnet/build-widget.png[Last Build in Builds widget,width=100%]

You can now select *Pipeline Overview* to see the stages of the Pipeline.
[.boxshadow]
image::tutorials/dotnet/test-stage-visible-pipeline-overview.png[Test stage runs successfully,width=100%]

The newly added "Test" stage is visible here.
Selecting the "Test" stage checkmark displays the stage output.
[.boxshadow]
image::tutorials/dotnet/test-stage-output.png[Test stage runs successfully (with output),width=100%]

Additionally, you can check the coverage result by navigating back to the job status page and selecting *Coverage Report*.

[.boxshadow]
image::tutorials/dotnet/test-coverage-result.png[Test coverage result,width=100%]
...
+
[.boxshadow]
image::tutorials/dotnet/deliver-stage-added.png[Deliver stage runs successfully,width=100%]
...
[.boxshadow]
image::tutorials/dotnet/deliver-stage-output.png[Deliver stage output only,width=100%]
. You can now select *dotnet-tutorial* (if that's the name you chose for your pipeline) from the breadcrumb navigation in the top-left to return to your pipeline main page.
...
[.boxshadow]
image::tutorials/dotnet/pipeline-runs.png[Pipeline overview interface with all previous runs displayed,width=100%]
...
[.boxshadow]
image::tutorials/dotnet/deliver-artifacts.png[Delivered artifacts,width=100%]
