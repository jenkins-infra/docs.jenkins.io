...
. In the *Repository URL* field (within *Connect to a Git repository*), specify
  ...
  xref:#fork-sample-repository[above], which is from your
...
+
[.boxshadow]
image:tutorials:ROOT:multibranch-pipeline-01-main-blueocean-interface.png[alt="Main
...
xref:ROOT:build-a-node-js-and-react-app-with-npm.adoc#create-your-initial-pipeline-as-a-jenkinsfile[``Create
your initial Pipeline...''] and
xref:ROOT:build-a-node-js-and-react-app-with-npm.adoc#add-a-test-stage-to-your-pipeline[``Add
...
. Click *Branches* at the top right to access the list of your Pipeline
  project's branches.
[.boxshadow]
image:tutorials:ROOT:multibranch-pipeline-11-branches-page.png[alt="Branches
page",width=100%]
. Click the run icon
  image:tutorials:ROOT:multibranch-pipeline-12-run-icon.png[alt="Run icon",width=3%]
...
[.boxshadow]
image:tutorials:ROOT:multibranch-pipeline-13-build-and-test-stages-run-successfully-with-output.png[alt="Build
...
* For an explanation of the `input message` steps, refer to annotation *4* of
  ...
  xref:ROOT:build-a-node-js-and-react-app-with-npm.adoc#add-a-final-deliver-stage-to-your-pipeline[``Add
...
[.boxshadow]
image:tutorials:ROOT:multibranch-pipeline-21-complete-pipeline-runs-successfully-on-master-branch.png[alt="Complete
...
[.boxshadow]
image:tutorials:ROOT:multibranch-pipeline-31-deliver-for-development-stage-opened.png[alt="Shell
...
. When you are finished viewing the page/site, click the *Proceed* button in
  ...
  *Deliver for development* stage was executed but the *Deploy for production*
  stage was not.
[.boxshadow]
image:tutorials:ROOT:multibranch-pipeline-32-complete-pipeline-runs-successfully-on-development-branch.png[alt="Complete
...
[.boxshadow]
image:tutorials:ROOT:multibranch-pipeline-41-deploy-for-production-stage-opened.png[alt="Shell
...
. When you are finished viewing the page/site, click the *Proceed* button in
  ...
  *Deploy for production* stage was executed but the *Deliver for development*
  stage was skipped.
[.boxshadow]
image:tutorials:ROOT:multibranch-pipeline-42-complete-pipeline-runs-successfully-on-production-branch.png[alt="Complete
...
. Click the *X* at the top-right to return to the *Activity* page of the Blue
  ...
  *Note:* Since your browser is likely to continue running the application's
  ...
  content from your browser xref:#clearing-the-app-from-your-browser[below].
...
. Back in Blue Ocean, run your Pipeline on the `development` branch (as you did
  xref:#run-your-pipeline-on-the-development-branch[above]) and check the results
...
. Back in Blue Ocean, run your Pipeline on the `production` branch this time (as
  you did xref:#run-your-pipeline-on-the-production-branch[above]) and check the
