...
*Duration:* This tutorial takes 20-40 minutes to complete if you've already met the
include::partial$prerequisites.adoc[prerequisites] below.

The exact duration depends on the speed of your machine and whether or not you've already xref:ROOT:create-a-pipeline-in-blue-ocean.adoc#run-jenkins-in-docker[run Jenkins in Docker] from xref:ROOT:index[another tutorial].
...
If you've already run though xref:ROOT:index.adoc[another tutorial], you can skip the include::partial$prerequisites.adoc[prerequisites] and xref:ROOT:create-a-pipeline-in-blue-ocean.adoc#run-jenkins-in-docker[run Jenkins in Docker] sections below and proceed to
include::partial$fork-sample-repository.adoc[forking the sample repository].
If you need to restart Jenkins, follow the restart instructions in xref:user-docs:installing-jenkins:partial$_setup-wizard-for-tutorials.adoc[run Jenkins in Docker] and then proceed.

include::partial$prerequisites.adoc[prerequisites]
