...
If you've already run though xref:ROOT:index.adoc[another tutorial], you can skip the prerequisites and xref:ROOT:create-a-pipeline-in-blue-ocean.adoc#run-jenkins-in-docker[run Jenkins in Docker] sections below and proceed to
