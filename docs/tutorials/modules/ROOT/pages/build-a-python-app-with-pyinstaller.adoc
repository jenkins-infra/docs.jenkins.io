...
If you've already run through , you can skip the
 and xref:#run-jenkins-in-docker[Run Jenkins in Docker] section below and proceed on to xref:#fork-sample-repository[forking the
sample repository]. (Just ensure you have

If you've already run through xref:index.adoc[another tutorial], you can skip the
xref:#prerequisites[Prerequisites] section below and proceed on to <xref:#fork-sample-repository[forking the
sample repository]. (Just ensure you have
