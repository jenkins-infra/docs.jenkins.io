...
You can download it from the https://www.putty.org/[official website].
...
https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/connect-linux-inst-from-windows.html[Connecting to Your Linux Instance from Windows Using PuTTY]