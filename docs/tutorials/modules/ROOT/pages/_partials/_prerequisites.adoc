...
** https://www.docker.com/[Docker] - Read more about installing Docker in the
   xref:user-docs:installing-jenkins:index.adoc#installing-docker[Installing Docker] section of
   the xref:user-docs:installing-jenkins:index.adoc[Installing Jenkins] page. +
