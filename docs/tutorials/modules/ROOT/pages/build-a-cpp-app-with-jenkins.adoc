...
[.boxshadow]
image::tutorials/cpp/build-stage-status.png[Build details,width=100%]

In the left navigation pane, you can select *Pipeline Overview* to see the stages of the Pipeline.

[.boxshadow]
image::tutorials/cpp/pipeline-overview-build-stage.png[Pipeline overview,width=100%]
...
[.boxshadow]
image::tutorials/cpp/pipeline-console-build-stage.png[Build stage,width=100%]
...
[.boxshadow]
image::tutorials/cpp/test-stage-overview.png[Test stage,width=100%]
...
[.boxshadow]
image::tutorials/cpp/test-stage-status.png[Test stage,width=100%]

You can now select *Pipeline Overview* to see the stages of the Pipeline.

[.boxshadow]
image::tutorials/cpp/pipeline-overview-test-stage.png[Pipeline overview with Test stage,width=100%]

The newly added "Test" stage is visible here. Selecting the "Test" stage checkmark displays the stage output.

[.boxshadow]
image::tutorials/cpp/pipeline-output-test-stage.png[Test stage output,width=100%]
...
+
[.boxshadow]
image::tutorials/cpp/deliver-overview.png[Deliver stage,width=100%]

. Select *#3*, or on the number representing your last build on the left, under *Build History*. 
+
[.boxshadow]
image::tutorials/cpp/deliver-overview-status.png[Deliver stage,width=100%]

. Select *Pipeline Overview* to see the stages of the Pipeline.
+
[.boxshadow]
image::tutorials/cpp/pipeline-overview-deliver-stage.png[Pipeline overview with Deliver stage,width=100%]
...
+
[.boxshadow]
image::tutorials/cpp/pipeline-console-deliver-stage.png[Deliver stage output,width=100%]

. You can see the full stage view by clicking on the "Full Stage View" in the left menu.
+
[.boxshadow]
image::tutorials/cpp/full-stage-view.png[Deliver stage output,width=100%]
