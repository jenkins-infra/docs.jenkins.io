...
* Potential mentors:
  ...
  link:/blog/authors/oleg_nenashev/[Oleg Nenashev],
  Vivek Sonar
* Documentation SIG xref:docs:index.adoc#members[members] and component maintainers assist as their time allows (link:/blog/authors/halkeye/[Gavin Mogan] and Meg McRoberts)
...
Participant links are also available in the xref:events:ROOT:index.adoc[Jenkins event calendar].
...
[#GSoD-2020]
* **xref:docs:gsod/2020/index.adoc[GSoD 2020]** xref:docs:gsod/2020/projects/document-jenkins-on-kubernetes.adoc[Document Jenkins on Kubernetes] by link:/blog/authors/zaycodes[Zainab Abubakar]
+
...
See the link:/blog/2020/12/04/gsod-project-report/[project report] by link:https://www.jenkins.io/blog/authors/zaycodes[Zainab Abubakar] for details of
