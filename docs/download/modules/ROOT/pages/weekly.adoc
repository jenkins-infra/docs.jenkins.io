...
The team also manages link:https://www.jenkins.io/changelog[changelogs] and the LTS backporting process.
...
.References
****
* link:https://www.jenkins.io/changelog[Jenkins Weekly Release changelog]
