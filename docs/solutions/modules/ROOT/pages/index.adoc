...
<div class="flex-container">
    <div class="card android">
        <a href="https://docs.jenkins.io/solutions/2.504.x/android">
            <div class="data">
                <p>
                    Android 
                </p>
    ...
    <div class="card bit-bucket">
        <a href="https://docs.jenkins.io/solutions/2.504.x/bitbucketserver">
            <div class="data ">
                <p>
                    Bit Bucket 
                </p>
    ...
    <div class="card c">
        <a href="https://docs.jenkins.io/solutions/2.504.x/c">
            <div class="data ">
                <p>
                    C/C++ 
                </p>
    ...
    <div class="card docker">
        <a href="https://docs.jenkins.io/solutions/2.504.x/docker">
            <div class="data ">
                <p>
                    Docker 
                </p>
    ...
    <div class="card embedded">
        <a href="https://docs.jenkins.io/solutions/2.504.x/embedded">
            <div class="data ">
                <p>
                    Embedded 
                </p>
    ...
    <div class="card github">
        <a href="https://docs.jenkins.io/solutions/2.504.x/github">
            <div class="data">
                <p>
                    Github 
                </p>
    ...
    <div class="card java">
        <a href="https://docs.jenkins.io/solutions/2.504.x/java">
            <div class="data ">
                <p>
                    Java
                </p>
    ...
    <div class="card php">
        <a href="https://docs.jenkins.io/solutions/2.504.x/php">
            <div class="data ">
                <p>
                    PHP 
                </p>
    ...
    <div class="card pipeline">
        <a href="https://docs.jenkins.io/solutions/2.504.x/pipeline">
            <div class="data ">
                <p>
                    Pipeline 
                </p>
    ...
    <div class="card python">
        <a href="https://docs.jenkins.io/solutions/2.504.x/python">
            <div class="data ">
                <p>
                    Python 
                </p>
    ...
    <div class="card ruby">
        <a href="https://docs.jenkins.io/solutions/2.504.x/ruby">
            <div class="data ">
                <p>
                    Ruby 
                </p>
