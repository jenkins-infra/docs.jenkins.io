...
See xref:./multibranch.adoc[the Multibranch documentation] for more information.

== Parameters

See xref:./jenkinsfile.adoc#handling-parameters[the Jenkinsfile documentation] for more information
...
See xref:./development.adoc#replay[the Replay documentation] for more information.
...
image::restart-stages-sidebar.png[Restart from Stage link]
...
image::restart-stages-dropdown.png[Choose the stage to restart]
...
image::pipeline-restart-stages-blue-ocean.png[Click on Restart link for stage]

include::blueocean:partial$_blue-ocean-status.adoc[]
