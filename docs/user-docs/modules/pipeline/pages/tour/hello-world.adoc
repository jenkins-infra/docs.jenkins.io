...
respective xref:user-docs:pipeline:index.adoc[Pipeline] and
xref:user-docs:pipeline:jenkinsfile.adoc[Using a Jenkinsfile] sections of the User
Handbook.
...
. Copy one of the xref:#examples[ examples below] into your repository and name it `Jenkinsfile`
. Click the *New Item* menu within Jenkins
image:user-docs:pipeline:classic-ui-left-column.png[alt="Classic UI left column",width=40%]
...
**xref:running-multiple-steps.adoc[Continue to "Run multiple steps"]**
...
---
**xref:running-multiple-steps.adoc[Continue to "Running multiple steps"]**

== Additional Resources

* See more detailed instructions on xref:user-docs:pipeline:getting-started.adoc[Getting Started with Pipeline]
* Review other xref:tutorials:ROOT:index.adoc#pipeline[Pipeline tutorials]
