:page-aliases: user-docs:administration:upgrade-java-guidelines.adoc
= Upgrade to Java 11
...
NOTE: If you discover a previously unreported issue, please let us know. Refer to xref:community:ROOT:report-issue.adoc[how to report an issue] for guidance.
