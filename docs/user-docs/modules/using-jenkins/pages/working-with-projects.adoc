...
* xref:pipeline:index.adoc[Pipeline]
* xref:pipeline:multibranch.adoc[Multibranch Pipeline]
* xref:pipeline:multibranch.adoc#organization-folders[Organization folders]
* Freestyle
