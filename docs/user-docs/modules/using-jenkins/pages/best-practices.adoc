...
* xref:#use-organization-folders[Use organization folders] - create, update, and delete multibranch Pipeline folders and Pipeline jobs automatically (preferred)
* xref:#use-multibranch-pipelines[Use multibranch Pipelines] - create, update and deleted Pipeline jobs automatically
* xref:#use-pipeline[Use Pipeline] - Manually defined Pipeline jobs for more control over the job management process.
...
Refer to the xref:pipeline:multibranch.adoc#organization-folders[organization folders] documentation for more details.
...
Refer to the xref:pipeline:multibranch.adoc#creating-a-multibranch-pipeline[creating multibranch Pipelines] documentation for more details.
...
Refer to the xref:pipeline:index.adoc[Pipeline] documentation for more details.
...
Refer to the xref:user-docs:security:controller-isolation.adoc[controller isolation] documentation for more details.
...
Refer to the xref:using-jenkins:fingerprints.adoc[fingerprinting page] for more information.
...
Refer to the xref:security:securing-jenkins.adoc[securing Jenkins] chapter of the User Handbook for more details.
...
More details can be found in the xref:system-administration:backing-up.adoc[backup documentation].
