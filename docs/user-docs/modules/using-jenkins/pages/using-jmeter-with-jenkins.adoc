...
To learn more about Jenkins agents, refer to the xref:using-jenkins:using-agents.adoc[using Jenkins agents] page.
...
The Jenkins docs has a page to help with the xref:installing-jenkins:index.adoc[Jenkins installation process.].
This guide uses the .jar installation.
Refer to the xref:user-docs:pipeline:tour/getting-started.adoc[guided tour page] if you want to use .jar as well.
