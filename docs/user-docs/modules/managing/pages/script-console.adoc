...
* xref:system-administration:backing-up.adoc[Backup your Jenkins configuration] before running scripts
* Use the xref:developer:security:misc.adoc[Jenkins API] rather than direct filesystem manipulation when possible
