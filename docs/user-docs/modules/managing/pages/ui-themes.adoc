...
(link:https://www.jenkins.io/blog/2018/06/27/new-login-page/[announcement]).
...
(e.g. see the ‘developer’ changes in the link:https://www.jenkins.io/changelog/[Jenkins changelog]),
...
There are multiple initiatives in the link:https://www.jenkins.io/project/roadmap/[Jenkins Roadmap] being coordinated by the xref:sigs:ux:index.adoc[Jenkins User Experience SIG].
...
please let the xref:sigs:advocacy-and-outreach:index.adoc[Advocacy&Outreach SIG] know!
