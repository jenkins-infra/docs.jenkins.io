...
Use these instructions if your Jenkins configuration is _not_ managed using Configuration as Code plugin or xref:managing:groovy-hook-scripts.adoc[Groovy Init Hooks].
...
If you are using a Groovy Script or a xref:managing:groovy-hook-scripts.adoc[Groovy Init Hook] to configure your authorization strategy,
