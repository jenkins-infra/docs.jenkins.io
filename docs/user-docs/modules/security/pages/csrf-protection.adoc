...
See link:https://www.jenkins.io/security/advisory/2019-07-17/#SECURITY-626[security advisory] and link:https://www.jenkins.io/doc/upgrade-guide/2.176/#SECURITY-626[upgrade guide].
...
Requests authenticating with an xref:system-administration:authenticating-scripted-clients.adoc[API token] are exempt from CSRF protection in Jenkins.
...
xref:managing:system-properties.adoc[Learn more about system properties in Jenkins].
