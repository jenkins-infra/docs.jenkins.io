:page-aliases: user-docs:system-administration:security.adoc
= Securing Jenkins
...
In addition to access control of users, xref:build-authorization.adoc[access control for builds] limits what builds can do, once started.
