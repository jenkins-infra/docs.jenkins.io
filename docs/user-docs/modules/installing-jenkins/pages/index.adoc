:page-aliases: user-docs:administration:jenkins-on-java-11.adoc, user-docs:administration:jenkins-on-java-17.adoc
= Installing Jenkins
...
See the xref:user-docs:installing-jenkins:servlet-containers.adoc[Servlet Container Support Policy] page for details.
