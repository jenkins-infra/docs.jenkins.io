...
Refer to xref:system-administration:security.adoc[Securing Jenkins] for more information.
...
Refer to the detailed list of xref:managing:system-properties.adoc#Featurescontrolledbysystemproperties-PropertiesinJenkinsCore[Jenkins properties] for more information.
