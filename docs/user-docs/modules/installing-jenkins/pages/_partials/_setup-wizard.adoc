...
[.boxshadow]
image:user-docs:installing-jenkins:setup-jenkins-01-unlock-jenkins-page.jpg[alt="Unlock Jenkins page",width=80%]
...
[.boxshadow]
image:user-docs:installing-jenkins:setup-jenkins-02-copying-initial-admin-password.png[alt="Copying initial admin password",width=80%] +
  *Note:* 
