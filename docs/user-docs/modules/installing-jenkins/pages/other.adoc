...
link:http://localhost:8080[localhost:8080] to xref:#setup-wizard[complete configuration of the Jenkins instance].
...
Generally it should suffice to install a xref:platform-information:support-policy-java.adoc[supported Java version], link:/download[download] the
