...
* xref:#debian-or-ubuntu[Debian/Ubuntu]
* xref:#fedora[Fedora]
* xref:#red-hat-centos[Red Hat/Alma/Rocky]
...
Additionally, xref:platform-information:support-policy-java.adoc[not all Java versions are compatible] with Jenkins.
