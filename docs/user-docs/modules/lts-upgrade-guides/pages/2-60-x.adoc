...
== Upgrading to Jenkins 2.60.3

No notable changes requiring upgrade notes.

== Upgrading to Jenkins 2.60.2

No notable changes requiring upgrade notes.

== Upgrading to Jenkins 2.60.1
...
If you're using the link:https://plugins.jenkins.io/ssh-slaves[SSH Build Agents] plugin, it may attempt to start the agent process on an unsupported JRE, which will fail.
...
link:https://issue-redirect.jenkins.io/issue/33358[JENKINS-33358], link:https://issue-redirect.jenkins.io/issue/42189[JENKINS-42189]

Groovy has been upgraded to 2.4.8 to fix a memory leak.

If you're using Pipeline, note that you will need to update the link:https://plugins.jenkins.io/workflow-cps[Pipeline: Groovy] plugin to version 2.28 or later.

=== Trilead SSH Library Upgrade

link:https://issue-redirect.jenkins.io/issue/42959[JENKINS-42959]
...
The link:https://plugins.jenkins.io/ssh-slaves[SSH Slaves] plugin should be upgraded to version 1.20 or newer.

=== RPM Packaging No Longer Performs Recursive `chown`

link:https://issue-redirect.jenkins.io/issue/23273[JENKINS-23273]
...
link:https://issue-redirect.jenkins.io/issue/39231[JENKINS-39231], link:https://issue-redirect.jenkins.io/issue/39237[JENKINS-39237]
...
See link:/doc/upgrade-guide/2.60/windows[Upgrading Windows masters and agents] for more details.
