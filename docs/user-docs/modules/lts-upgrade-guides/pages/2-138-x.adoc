...
WARNING: Please note that downgrading Jenkins is not generally supported, and may fail for reasons unrelated to this migration.
...
link:https://www.jenkins.io/security/advisory/2018-12-05/#SECURITY-595[For further details, see the security advisory].
...
Whenever either happens, Jenkins writes a message similar to the following to the Jenkins system log:

----
WARNING: New Stapler routing rules result in the URL "/example" no longer being
allowed. If you consider it safe to use, add the following to the whitelist:
"method hudson.model.Hudson doExample". Learn more:
https://jenkins.io/redirect/stapler-routing
----
...
We track known affected plugins and their status in https://wiki.jenkins.io/display/JENKINS/Plugins+affected+by+the+SECURITY-595+fix[the Jenkins wiki].
...
link:https://issue-redirect.jenkins.io/issue/53998[JENKINS-53998]

When starting Jenkins 2.138.2 for the first time, a warning like the following might be logged if the link:https://plugins.jenkins.io/jobConfigHistory[Job Config History Plugin] is installed in a version older than 2.19.

----
Oct 10, 2018 2:27:17 PM hudson.ExtensionFinder$GuiceFinder$FaultTolerantScope$1 error
WARNING: Failed to instantiate Key[type=jenkins.telemetry.Correlator,
annotation=[none]]; skipping this component
com.google.inject.ProvisionException:
Unable to provision, see the following errors:

1) Tried proxying jenkins.telemetry.Correlator to support a circular dependency,
...
link:https://issue-redirect.jenkins.io/issue/54031[JENKINS-54031]

A security hardening in 2.138.2 and 2.146 can result in problems accessing jobs with link:https://plugins.jenkins.io/github-oauth[GitHub OAuth Plugin] due to a bug in the plugin.
...
WARNING: Please see the link:http://localhost:4242/security/advisory/2018-12-05/#SECURITY-595[description of SECURITY-595 in the 2018-12-05 security advisory] for important information about this workaround.

== Upgrading to Jenkins 2.138.1

=== New login and user signup pages

link:/blog/2018/06/27/new-login-page/[Announcement blog post], link:https://issue-redirect.jenkins.io/issue/50447[JENKINS-50447]
...
See the link:https://www.jenkins.io/blog/2018/06/27/new-login-page/[announcement blog post] for further information.

=== New API token system

link:/blog/2018/07/02/new-api-token-system/[Announcement blog post], link:https://issue-redirect.jenkins.io/issue/32442[JENKINS-32442], link:https://issue-redirect.jenkins.io/issue/32776[JENKINS-32776]
...
link:https://issue-redirect.jenkins.io/issue/48480[JENKINS-48480]
...
link:https://issues.jenkins.io/browse/JENKINS-52771[JENKINS-52771]
...
See link:https://issues.jenkins.io/browse/JENKINS-53924[JENKINS-53924] and link:https://issues.jenkins.io/browse/JENKINS-53832[JENKINS-53832] for more info.
