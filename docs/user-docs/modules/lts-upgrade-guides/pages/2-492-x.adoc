...
By default, the link:https://plugins.jenkins.io/configuration-as-code[Configuration as Code Plugin] cancels Jenkins startup when a deprecated section is detected.
