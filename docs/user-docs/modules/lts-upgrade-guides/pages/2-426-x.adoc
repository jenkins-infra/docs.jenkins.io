...
Refer to the specific https://hub.docker.com/r/jenkins/jenkins/tags?page=1&name=jdk21[Java 21 container images on hub.docker.com] for more details.
...
The list of plugins can be found in our https://docs.google.com/spreadsheets/d/1dpaKALZaK0_HIGy6ony3wnegr1frTg3u1lngG4KdoC8/edit#gid=0[tracking sheet].
At this time, there are several plugins with over 800 installs that have not removed Prototype from their configuration.
These plugins are:

* https://issue-redirect.jenkins.io/issue/71303[Fortify]
* https://github.com/jenkinsci/xray-connector-plugin/issues/75[Xray Connector]
* https://issue-redirect.jenkins.io/issue/71308[Synopsys Coverity]
* https://issue-redirect.jenkins.io/issue/71309[qTest]
* https://issue-redirect.jenkins.io/issue/71311[Azure App Service]

There are other plugins, all under 700 installs, that have issues created for them in the Jenkins issue tracker, linked to the overall https://issue-redirect.jenkins.io/issue/70906[Prototype removal epic].
...
* https://plugins.jenkins.io/theme-manager[Theme Manager]
* https://plugins.jenkins.io/dark-theme[Dark Theme]
* https://plugins.jenkins.io/simple-theme-plugin[Simple Theme]
* https://plugins.jenkins.io/customizable-header[Customizable Header]
* https://plugins.jenkins.io/customize-build-now[Customize Build Now Label]
...
The treeview option was using inline JavaScript, going against the https://www.jenkins.io/doc/developer/security/csp/#inline-javascript-blocks[Jenkins CSP standards].
This is also part of the larger project to https://issues.jenkins.io/browse/JENKINS-71014[remove or update any non-compliant code in Jenkins core].
...
=== End of support for Red Hat Enterprise Linux 7 and its derivatives

The May 30, 2023 https://www.jenkins.io/blog/2023/05/30/operating-system-end-of-life/[end of life operating systems blog post] announced the end of support for Red Hat Enterprise Linux 7 and its derivatives like CentOS 7, Scientific Linux 7, and Oracle Linux 7.
...
* https://access.redhat.com/products/discover-red-hat-enterprise-linux/[Red Hat Enterprise Linux] 8 or 9
* https://almalinux.org/[AlmaLinux] 8 or 9
* https://rockylinux.org/[Rocky Linux] 8 or 9
* https://www.oracle.com/linux/[Oracle Linux] 8 or 9
