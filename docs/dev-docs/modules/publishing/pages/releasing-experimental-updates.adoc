...
One of the methods to release experimental updates is using the link:https://github.com/jenkinsci/plugin-installation-manager-tool[Plugin Installation Manager Tool] combined with xref:plugin-development:incrementals.adoc[incremental] builds:
