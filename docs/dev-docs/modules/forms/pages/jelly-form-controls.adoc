...
Most of the jelly files in the Jenkins source have embedded documentation. See xref:dev-docs:development-environment:ide-configuration.adoc[IDE Configuration] for details on how to get this setup so you can click through to it in your IDE.
