...
When updating the core dependency, choose the link:https://www.jenkins.io/changelog-stable/[newest LTS version] that doesn't exclude a majority of your existing users (by requiring a newer Jenkins than they have).
