...
For example, the link for the git plugin is articipate/report-issue/redirect/#15543[https://www.jenkins.io/participate/report-issue/redirect/#15543], while the link for the elastic axis plugin is articipate/report-issue/redirect/#17588[https://www.jenkins.io/participate/report-issue/redirect/#17588].
