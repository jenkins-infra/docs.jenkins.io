...
Instructions are available on the xref:publishing:wiki-page.adoc#migrating-from-wiki-to-github[www.jenkins.io] site.
...
Follow the xref:publishing:wiki-page.adoc#migrating-from-wiki-to-github[plugin documentation migration instructions].
