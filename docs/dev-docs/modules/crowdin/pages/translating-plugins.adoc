...
image::images:ROOT:developer/crowdin/crowdin-ui.png[Crowdin translation UI]
...
image::images:ROOT:developer/crowdin/source-string-list.png[source string list]
...
image::images:ROOT:developer/crowdin/to-translate.png[]
...
image::images:ROOT:developer/crowdin/translated.png[]
...
image::images:ROOT:developer/crowdin/proofread.png[]

==== Propose a translation

The box right to the string overview is where you can propose translations.

image::images:ROOT:developer/crowdin/translation-proposal.png[]
