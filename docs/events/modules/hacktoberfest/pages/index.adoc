...
create new xref:images:ROOT:index.adoc[artwork], etc.
...
* for other repositories, we will need to get the repo marked for Hacktoberfest so that your pull request counts towards the goal.
  Please follow xref:events:hacktoberfest:faq.adoc#how-do-i-mark-my-pull-requests[FAQ: Marking Pull requests].
...
| Documentation, +
  ...
  CSS, +
  Ruby
| Extend and improve Jenkins documentation, help to improve the website's look&feel, create link:https://www.jenkins.io/blog/[a new blogpost], a technology-specific solution page or a tutorial.
