...
image:images:ROOT:logos/worldwide/256.png[Jenkins Online Meetup logo, role=center, float=right,role=float-gap]
...
* xref:project:ROOT:conduct.adoc[Jenkins Code of Conduct] - All events on the Jenkins meetup must adhere to the project's code of conduct
* xref:projects:jam:index.adoc[Local Jenkins meetups] - For those who want to organize local events
