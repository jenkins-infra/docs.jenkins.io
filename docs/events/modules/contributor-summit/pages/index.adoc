...
xref:community:chat:index.adoc#irc[More info].
...
Should you want to use an email instead of the channels above, please use one of the xref:community:mailing-lists:index.adoc[Jenkins mailing lists].
For organization matters, please use the xref:community:mailing-lists:index.adoc#jenkins-advocacy-and-outreach-sig-googlegroups-com[Advocacy and Outreach SIG] mailing list.

== Archive

=== Previous events

* xref:events:contributor-summit:archive/2021-10.adoc[Online Contributor Summit on Oct 2, 2021 and Oct 9, 2021]
* xref:events:contributor-summit:archive/2021-06.adoc[Online Contributor Summit on Jun 25, 2021]
* link:https://www.jenkins.io/blog/2021/02/16/contributor-summit-online/[Online Contributor Summit on Feb 23-25, 2021]
* link:https://www.meetup.com/jenkinsmeetup/events/267684785/[2020 contributor summit at FOSDEM]
* link:https://www.jenkins.io/blog/2019/08/25/jenkinsworld-contrib-summit-ask-the-expert-booth/[2019 contributor summit blog post]
* link:https://www.jenkins.io/blog/2018/10/18/contributor-summit-summary/[2018 contributor summit summary]
...
+++ </summary><div> +++
image:images:ROOT:conferences/contributor_summit_kk.jpg[Jenkins Contributor Summit, 2018. Image 1, role=center]
+++ </div></details> +++

+++ <details><summary> +++
Jenkins Contributor Summit, 2018:
+++ </summary><div> +++
image:images:ROOT:conferences/contributor_summit_sf.jpg[Jenkins Contributor Summit, 2018. Image 2, role=center]
+++ </div></details> +++

+++ <details><summary> +++
Jenkins Contributor Summit, 2021:
+++ </summary><div> +++
image:images:ROOT:post-images/2021/2021-02-16-contributor-summit.png[Jenkins Contributor Summit, Feb 2021, role=center]
+++ </div></details> +++
