...
The event will have the link:https://www.jenkins.io/blog/2020/04/30/jenkins-is-the-way/[Jenkins is the Way] theme.
...
* Renew the Windows installation guide for Jenkins weekly releases that use the new Windows installer.
  See link:https://www.jenkins.io/blog/2019/02/01/windows-installers/[this blogpost] for an overview of the new Windows Installer.
* **Advanced:** Rewrite the xref:user-docs:installing-jenkins:docker.adoc[Docker installation guide] to use the `jenkins/jenkins` image instead of the Blue Ocean images.
...
* Migrate plugin documentation as documented in these link:https://www.jenkins.io/blog/2019/10/21/plugin-docs-on-github/[guidelines]).
...
* Write case studies and feature overviews for the link:https://www.jenkins.io/blog[Jenkins blog] and other resources.
...
* May 25, 03:00-04:00 PM UTC -
  _Beautify the UI of Jenkins reporter plugins_ by link:https://www.jenkins.io/blog/authors/uhafner/[Ullrich Hafner]
  (link:https://www.meetup.com/Jenkins-online-meetup/events/270767392/[details])
* May 25, 04:00-04:30 PM UTC -
  _Jenkins is The Way program overview_ by link:https://www.jenkins.io/blog/authors/alyssat/[Alyssa Tong]
  (link:https://www.meetup.com/Jenkins-online-meetup/events/270767571/[details])
* May 26, 10:00-10:45 AM UTC -
  _Migrating plugins to Documentation-as-Code_ by link:https://www.jenkins.io/blog/authors/oleg_nenashev/[Oleg Nenashev]
  (link:https://www.meetup.com/Jenkins-online-meetup/events/270775512[details])
* May 26, 13:00-14:00 PM UTC -
  _System Read Permission: Demo and contributing_ by link:https://www.jenkins.io/blog/authors/timja/[Tim Jacomb]
  (link:https://www.meetup.com/Jenkins-online-meetup/events/270775558/[details])
* May 26, 15:00-16:00 PM UTC -
  _Migrating documentation to jenkins.io_ by link:https://www.jenkins.io/blog/authors/markewaite/[Mark Waite]
...
* May 27, 10:00-11:00 AM UTC -
  ...
  by link:https://github.com/TobiX/[Tobias Gruetzmacher], link:https://www.jenkins.io/blog/authors/oleg_nenashev/[Oleg Nenashev], and link:https://www.jenkins.io/blog/authors/timja/[Tim Jacomb]
...
* May 29, 11:00-12:00 AM UTC -
  ...
  by link:https://www.jenkins.io/blog/authors/xiongkezhi/[Kezhi Xiong]
...
* Jun 01, 11:00-12:00 AM UTC -
  ...
  by link:https://www.jenkins.io/blog/authors/sladyn98/[Sladyn Nunes]
  (link:https://www.meetup.com/Jenkins-online-meetup/events/270974407/[details])
* Jun 01, 02:00-03:00 PM UTC -
  _Hackfest results_
  by link:https://www.jenkins.io/blog/authors/oleg_nenashev/[Oleg Nenashev] and link:https://www.jenkins.io/blog/authors/markewaite/[Mark Waite]
...
* xref:events:ROOT:index.adoc#event-calendar[Jenkins event calendar] - full list of events in the Jenkins project.
...
See xref:events:online-hackfest:2020-uiux/faq.adoc[here].
...
CDF also sponsors our xref:events:online-meetup:index.adoc[online meetup platform] which we will be using for the event.
