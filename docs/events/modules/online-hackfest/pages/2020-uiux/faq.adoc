...
There are lists of such newbie-friendly issues, see the links in our xref:events:hacktoberfest:index.adoc#featured-projects[featured project list].
...
* link:https://www.jenkins.io/blog/2017/08/07/intro-to-plugin-development/[Plugin Development Tutorials]
