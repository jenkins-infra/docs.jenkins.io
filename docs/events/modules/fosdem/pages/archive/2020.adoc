= Jenkins at FOSDEM 2020

Jenkins project has participated in FOSDEM 2020.
This event is coordinated by the xref:sigs:advocacy-and-outreach:index.adoc[Jenkins Advocacy and Outreach SIG].
Current plan:

* **Jan 30** - Jenkins Pipeline Fundamentals training led by link:https://www.jenkins.io/blog/authors/MarkEWaite/[Mark Waite] (link:https://www.eventbrite.com/e/jenkins-pipeline-fundamentals-training-tickets-87080214265[Register here])
