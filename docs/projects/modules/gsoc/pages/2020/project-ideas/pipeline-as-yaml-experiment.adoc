...
See the alpha release announcement link:https://www.jenkins.io/blog/2018/07/17/simple-pull-request-plugin/[here].
...
* Try out examples documented in the repository and in the link:https://www.jenkins.io/blog/2018/07/17/simple-pull-request-plugin/[Pipeline as YAML blog post]
...
* link:https://www.jenkins.io/blog/2018/07/17/simple-pull-request-plugin/[Pipeline as YAML blog post]
* link:https://jenkins-x.io/v3/develop/pipelines/[Jenkins X Pipelines]
* link:https://www.jenkins.io/blog/2019/01/08/mpl-modular-pipeline-library/[Modular Pipeline Library]
