...
==== Resources
  ...
  . Blogs
  - link:https://www.jenkins.io/blog/2019/06/29/phase-1-multibranch-pipeline-support-for-gitlab/[Coding phase 1 summary]
...
==== Resources
  ...
  . Blogs
  - link:https://www.jenkins.io/blog/2019/08/23/introducing-gitlab-branch-source-plugin/[Coding phase 3 summary]
