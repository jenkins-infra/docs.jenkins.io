...
* link:https://www.jenkins.io/blog/2019/08/19/remoting-kafka-kubernetes-release-2/[Release 2.0 Blog Post]
...
* link:https://www.jenkins.io/blog/2019/07/11/remoting-kafka-kubernetes-phase-1/[Phase 1 Blog Post]
