...
The alpha release was announced in the following link:https://www.jenkins.io/blog/2019/07/02/plugin-management-tool-alpha-release/[blog post]
...
The blog post announcing the new features can be found link:https://www.jenkins.io/blog/2019/07/30/plugin-management-tool-phase2-updates/[here] and the demo
...
from my presentation. I detailed my time at DevOps World link:https://www.jenkins.io/blog/2019/08/22/devops-world/[here].
