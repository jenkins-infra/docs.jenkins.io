= Jenkins in Google Summer of Code 2018
...
* xref:projects:gsoc:2018/code-coverage-api-plugin.adoc[Code Coverage API Plugin]
* xref:projects:gsoc:2018/remoting-over-message-bus.adoc[Jenkins Remoting over Message Bus/Queue]
* xref:projects:gsoc:2018/simple-pull-request-job-plugin.adoc[Simple Pull-Request Job Plugin]

Not started:

* xref:projects:gsoc:2018/eda-plugins.adoc[Electronic Design Automation Plugins]

=== Results and Retrospective

* link:https://www.jenkins.io/blog/2018/10/14/gsoc2018-results/[GSoC 2018 results] 
...
* xref:projects:gsoc:gsoc2018-project-ideas.adoc[GSoC 2018 Project ideas]
* link:https://www.jenkins.io/blog/2018/01/06/gsoc2018-call-for-mentors[Call for Mentors]
