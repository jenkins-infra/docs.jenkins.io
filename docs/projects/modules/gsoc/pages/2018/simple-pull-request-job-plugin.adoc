...
link:https://www.jenkins.io/blog/2018/06/15/simple-pull-request-plugin/[Phase 1 Blog Post](June 15, 2018)
...
* A format for “Jenkinsfile.yaml”. (All details present in link:https://www.jenkins.io/blog/2018/07/17/simple-pull-request-plugin/[Phase 2 Blog Post])
* Tools property in agent section of Jenkinsfile.yaml.
* Some tests for the plugin.
* Documentation for yaml examples written

link:https://www.jenkins.io/blog/2018/07/17/simple-pull-request-plugin/[Phase 2 Blog Post](July 17, 2018)
...
link:https://www.jenkins.io/blog/2018/08/14/simple-pull-request-plugin-final-evaluation/[Phase 3 Blog Post]
