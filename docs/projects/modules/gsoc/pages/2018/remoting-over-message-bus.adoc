...
* xref:projects:gsoc:2018/remoting-over-message-bus.adoc[Project Info]
* link:https://www.jenkins.io/blog/2018/06/18/remoting-over-message-bus/[Introduction Blogpost]
