...
xref:community:chat:index.adoc#continuous-delivery-foundation[Explanations about the CDF Slack] (the invitation link is at the end of the paragraph).
...
* xref:#chat[Chat]
* xref:projects:gsoc:2022/project-ideas/jenkinsfile-runner-action-for-github-actions.adoc[Original GSoC Project Idea]
* xref:gsoc:index.adoc#office-hours[Meetings]
* https://docs.google.com/document/d/1SC__C6V8LFZvs99uR4fqoraJPcF_-JG5QhvBdaYaVFo/edit?usp=sharing[Meeting Notes]
