...
* xref:projects:gsoc:2022/projects/plugin-health-scoring-system.adoc[Plugin Health Scoring System] by Dheeraj Singh Jodha
* xref:projects:gsoc:2022/projects/jenkinsfile-runner-action-for-github-actions.adoc[Jenkinsfile Runner Action for GitHub Actions] by Yiming Gong
* xref:projects:gsoc:2022/projects/automatic-git-cache-maintenance.adoc[Automatic git cache maintenance on the controller] by Hrushikesh Rao
* xref:projects:gsoc:2022/projects/pipeline-step-documentation-generator.adoc[Pipeline Step Documentation Generator Improvements] by Vihaan Thora

They were proposed and selected from these xref:gsoc:2022/project-ideas.adoc[project ideas].
...
* xref:projects:gsoc:2021/index.adoc[GSoC 2021] - 5 student projects
* xref:projects:gsoc:2020/index.adoc[GSoC 2020] - 7 student projects
* xref:projects:gsoc:2019/index.adoc[GSoC 2019] - 7 student projects
* xref:projects:gsoc:2018/index.adoc[GSoC 2018] - 3 student projects
* xref:projects:gsoc:gsoc2017.adoc[GSoC 2017] - not accepted
* xref:projects:gsoc:gsoc2016.adoc[GSoC 2016] - 5 student projects
* link:https://wiki.jenkins.io/display/JENKINS/Google+Summer+of+Code+2009[GSoC 2009] - as Hudson, not accepted

.References
****, 2022

* xref:gsoc:2022/project-ideas.adoc[GSoC 2022 project ideas]
* link:https://summerofcode.withgoogle.com/programs/2022/organizations/jenkins-wp/[Jenkins page on the GSoC website]
 * link:https://www.jenkins.io/blog/2022/01/07/gsoc-2022/[GSoC 2022 announcement]
****
