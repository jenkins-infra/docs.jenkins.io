...
* xref:projects:gsoc:2025/projects/ai-powered-chatbot-for-quick-access-to-jenkins-resources.adoc[AI-Powered Chatbot for Quick Access to Jenkins Resources] with link:https://github.com/giovanni-vaccarino/[Giovanni Vaccarino] as the GSoC contributor.

* xref:projects:gsoc:2025/projects/complete-alternative-jenkins-io-build-retooling.adoc[Complete build retooling of jenkins.io] with link:https://github.com/biru-codeastromer/[Birajit Saikia] as the GSoC contributor.

* xref:projects:gsoc:2025/projects/domain-specific-LLM-based-on-jenkins-usage-using-ci-jenkins-io-data.adoc[Domain-specific LLM based on actual Jenkins usage using ci.jenkins.io data] with link:https://github.com/chiruu12/[Chirag Gupta] as the GSoC contributor.

* xref:projects:gsoc:2025/projects/improving-tekton-client-plugin.adoc[Improving Tekton Client Plugin for Jenkins] with link:https://github.com/maeveho25/[Maeve Ho] as the GSoC contributor.

* xref:projects:gsoc:2025/projects/plugin-modernizer-improvements.adoc[Improving Plugin Modernizer] with link:https://github.com/CodexRaunak/[Raunak Madan] as the GSoC contributor.

They were proposed and selected from these xref:gsoc:2025/project-ideas.adoc[project ideas].
...
* We use the link:https://www.jenkins.io/sigs/gsoc[GSoC SIG] for communications about GSoC.
...
* link:https://www.jenkins.io/chat/[Common developer chats] for technical topics
...
Use the https://www.jenkins.io/events/[Jenkins event calendar] to view the meeting time in your own time zone.
...
You can add the office hours to your calendar when you visit the link:https://www.jenkins.io/event-calendar[Jenkins event calendar].
...
* xref:2024/index.adoc[GSoC 2024] - 5 contributor projects
* xref:2023/index.adoc[GSoC 2023] - 4 contributor projects
* xref:2022/index.adoc[GSoC 2022] - 4 contributor projects
* xref:2021/index.adoc[GSoC 2021] - 5 contributor projects
* xref:2020/index.adoc[GSoC 2020] - 7 contributor projects
* xref:2019/index.adoc[GSoC 2019] - 7 contributor projects
* xref:2018/index.adoc[GSoC 2018] - 3 contributor projects
* xref:gsoc2017.adoc[GSoC 2017] - not accepted
* xref:gsoc2016.adoc[GSoC 2016] - 5 contributor projects
* link:https://wiki.jenkins.io/display/JENKINS/Google+Summer+of+Code+2009[GSoC 2009] - as Hudson, not accepted

== References, 2025

* link:https://www.jenkins.io/projects/gsoc/2025/project-ideas/[GSoC 2025 project ideas]
* link:https://summerofcode.withgoogle.com/programs/2025/organizations/jenkins-wp/[Jenkins page on the GSoC website]
* link:https://jenkins.io/blog/2025/02/23/gsoc2025-announcement/[Jenkins GSoC 2025 announcement]
