= Google Summer of Code - Information for GSoC Contributors
...
See xref:projects:gsoc:index.adoc[the main GSoC project] page for other information and links.
...
. Check out the link:https://jenkins.io/projects/gsoc/2024/project-ideas[GSoC 2024 Project ideas]
...
. Add GSoC office hours to your calendar (to be announced on xref:projects:gsoc:index.adoc[the main GSoC project] page).
...
to write their proposals. Contributor proposals should not be confused with xref:proposing-project-ideas.adoc[project ideas].
...
* xref:project:ROOT:governance.adoc[Project Governance]
* xref:community:ROOT:index.adoc[Participate and Contribute]
* link:https://wiki.jenkins.io/display/JENKINS/Plugin+tutorial[Plugin tutorial]
* link:https://www.jenkins.io/blog/2017/08/07/intro-to-plugin-development/[Plugin Development Tutorials, Videos, and More]
...
** link:https://www.jenkins.io/blog/2018/07/23/remoting-kafka-plugin-1/[Remoting over Kafka]
** link:https://www.jenkins.io/blog/2018/08/17/code-coverage-api-plugin-1/[Code Coverage API]
* GSoC 2016 blog post:
** link:https://www.jenkins.io/node/tags/external-workspace-manager/[External Workspace Manager]
...
* xref:projects:gsoc:index.adoc#org-admins[Org admins mailing list]- for **private** communications with org admins (escalations, issues with mentors)
...
See the xref:projects:gsoc:index.adoc#office-hours[main GSoC page] for the schedule.
...
. Present your work at a local xref:projects:jam:index.adoc[Jenkins Area Meetup]
