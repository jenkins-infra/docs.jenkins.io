...
""
image:images:ROOT:blueocean/press/pipeline-editor.png[Editor, role=center, width=853]
image:images:ROOT:blueocean/press/pipeline-editor-step.png[Editor with open step, role=center, width=853]
...
""
image:images:ROOT:blueocean/press/pipeline-visualization.png[Pipeline visualization, role=center, width=853]
...
""
image:images:ROOT:blueocean/press/pipeline-diagnosis.png[Pipeline diagnosis, role=center, width=853]
...
""
image:images:ROOT:blueocean/press/personalization.png[Personalized dashboard, role=center, width=853]
...
""
image:images:ROOT:blueocean/press/github-status.png[Github integration, role=center, width=853]
