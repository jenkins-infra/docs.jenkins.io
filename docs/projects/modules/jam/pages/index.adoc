...
We also have a xref:events:online-meetup:index.adoc[Jenkins Online Meetup].
...
If you would like to organize an online event, please see the xref:events:online-meetup:index.adoc[Jenkins Online Meetup page].
