...
:page-author: oleg-nenashev, slide_o_mix, uhafner
:page-opengraph: ../../images/images/governance/elections/2020/opengraph.png
description: >
  This blogpost summarizes
---

image:/images/images/governance/elections/2020/opengraph.png[Jenkins Elections, role=center, float=right, height=178]
