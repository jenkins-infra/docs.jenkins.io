...
image::/images/images/post-images/2016-10-27/job-7-report.png[Test reporting with JUnit, width=800, role="center"]
...
image::/images/images/post-images/2016-10-27/job-7-console.png[JUnit plugin console output, width=800, role="center"]
...
image::/images/images/post-images/2016-10-27/job-8-summary.png[Test reporting with xUnit, width=800, role="center"]

image::/images/images/post-images/2016-10-27/job-8-console.png[xUnit plugin console output, width=800, role="center"]
...
image::/images/images/post-images/2016-10-27/job-9-summary.png[Accept a baseline of failing tests., width=800, role="center"]
...
image::/images/images/post-images/2016-10-27/job-10-summary.png[All tests pass!, width=800, role="center"]
...
image::/images/images/post-images/2016-10-27/job-12-summary.png[All tests pass!, width=800, role="center"]
...
image::/images/images/post-images/2016-10-27/job-17-summary.png[The pain of flaky tests failing the build, width=800, role="center"]
...
image::/images/images/post-images/2016-10-27/job-19-summary.png[Flaky tests don't have to fail the build, width=800, role="center"]

image::/images/images/post-images/2016-10-27/job-18-report.png[Results from flaky test, width=800, role="center"]
