...
During Hacktoberfest the playlist about modernizing jenkins plugins by link:/author/markewaite[Mark Waite] and link:/author/darinpope/[Darin Pope] was really helpful. 
