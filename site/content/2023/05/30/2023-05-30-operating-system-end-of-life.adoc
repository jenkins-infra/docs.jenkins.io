...
:page-opengraph: ../../images/images/post-images/2023/05/30/operating-system-end-of-life.png
:page-layout: blog
...
image::/images/images/post-images/2023/05/30/operating-system-end-of-life-monitor.png[Operating system end of life warning]
