...
:page-opengraph: ../../images/images/gsoc/2023/GSoC2023-here_we_come.png
description:   Jenkins project selected as Google Summer of Code 2023 mentoring organization.
---
...
image:/images/images/gsoc/2023/GSoC2023-here_we_come.png[Here we come]
