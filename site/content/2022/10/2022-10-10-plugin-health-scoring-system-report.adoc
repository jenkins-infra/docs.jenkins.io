...
:page-opengraph: ../../images/images/gsoc/2022/plugin-health-score/introducing-the-plugin-health-scoring-system.png
description:   The Plugin Health Scoring System is a Google Summer of Code 2022 project.
links:
  gitter: https://app.gitter.im/#/room/#jenkinsci_GSoC-Plugin_Health_Score:gitter.im
---

image::/images/images/gsoc/2022/plugin-health-score/introducing-the-plugin-health-scoring-system.png[GSoC, height=400, role=center, float=center]
...
* Visit link:https://plugin-health.jenkins.io[plugin-health.jenkins.io] to view a list of active probes. A big thanks to the Jenkins Infrastructure team (especially link:/author/hlemeur[Hervé Le Meur] and link:/author/dduportal[Damien Duportal]) for their help and support throughout.
...
* I'm extremely grateful to have been given this opportunity to contribute to the Jenkins project. I owe it to my mentors for being able to help take this project forward and learn lots of things along the way. Shoutout to link:/author/alecharp[Adrien Lecharpentier] and link:/author/jleon/[Jake Leon]. They invested tremendous time and energy in mentoring me and driving this project forward. They synced with me weekly and made sure that I was learning and that we were taking this project forward, 1 PR at a time.
...
* Also, thanks to the org admins, link:/author/jmmeessen[Jean-Marc Meessen], link:/author/alyssat[Alyssa Tong], and link:/author/krisstern/[Kris Stern], for always keeping me and other contributors on our toes and assisting us with any blockers and concerns by organizing weekly stand-up calls.
