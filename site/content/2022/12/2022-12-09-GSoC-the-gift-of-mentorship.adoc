...
description:   A nice gift is to mentor young developers participating in Google Summer of Code (GSoC)
links:
  discourse: https://community.jenkins.io/t/jenkins-in-gsoc-2023-mentors-org-admins-project-ideas-wanted/4387
---

image:/images/images/gsoc/Merry_Mentor.png[Jenkins GSoC, role=center, float=center]
