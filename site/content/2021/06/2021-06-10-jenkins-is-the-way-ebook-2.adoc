...
:page-author: alyssat
:page-opengraph: ../../images/images/post-images/jenkins-is-the-way/ebook/ebook2_opengraph.png
links:
  discourse: https://community.jenkins.io/t/new-ebook-jenkins-is-the-way-for-it-and-software-developers/136
---

image:/images/images/post-images/jenkins-is-the-way/ebook/ebook2_front.png["Jenkins Is The Way. User Stories IT-eBook",role=right,width=300]
