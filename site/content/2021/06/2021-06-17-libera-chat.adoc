...
:page-opengraph: ../../images/images/post-images/2021-06-libera-chat/jenkins-irc-on-libera-chat-opengraph.png

image:/images/images/post-images/2021-06-libera-chat/jenkins-irc-on-libera-chat-opengraph.png[Jenkins IRC now on Libera Chat, role=center, link="/chat/#internet-relay-chat-irc"]
