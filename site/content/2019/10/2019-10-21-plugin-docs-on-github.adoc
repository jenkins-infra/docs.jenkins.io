...
:page-opengraph: ../../images/images/post-images/2019-github-documentation/thumbnail.png
...
image:/images/images/post-images/2019-github-documentation/thumbnail.png[GitHub Documentation example, role=center]
...
image:/images/images/post-images/2019-github-documentation/role-strategy-screenshot.png[Role Strategy example, role=center]
