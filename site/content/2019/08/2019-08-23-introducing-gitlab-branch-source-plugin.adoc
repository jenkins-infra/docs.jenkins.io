...
:page-author: baymac
:page-opengraph: ../../images/images/post-images/gsoc-gitlab-branch-source-plugin/gitlab_and_jenkins.png
...
image::/images/images/post-images/gsoc-gitlab-branch-source-plugin/branch-source.png[GitLab Project Branch Source]
...
image::/images/images/post-images/gsoc-gitlab-branch-source-plugin/multibranch-indexing.png[Multibranch Pipeline Job Indexing]

After the indexing, the imported project listed all the branches, merge requests and tags as jobs.

image::/images/images/post-images/gsoc-gitlab-branch-source-plugin/multibranch-folder.png[Multibranch Pipeline Job Folder]
...
image::/images/images/post-images/gsoc-gitlab-branch-source-plugin/icon-tag.png[Build Actions]

== Create a GitLab Group Job Type

Go to Jenkins > New Item > GitLab Group

image::/images/images/post-images/gsoc-gitlab-branch-source-plugin/gitlab-group.png[GitLab Folder Organization]
...
image::/images/images/post-images/gsoc-gitlab-branch-source-plugin/gitlab-group-folder.png[GitLab Group Folder]
...
image::/images/images/post-images/gsoc-gitlab-branch-source-plugin/pipeline-status.png[GitLab Pipeline Status]
...
image::/images/images/post-images/gsoc-gitlab-branch-source-plugin/trusted-members.png[Trusted Member Strategy]
...
image::/images/images/post-images/gsoc-gitlab-branch-source-plugin/log-comment-trait.png[Build Status Comment Trait]
...
image::/images/images/post-images/gsoc-gitlab-branch-source-plugin/build-trigger-trait.png[Merge request build trigger]
...
image::/images/images/post-images/gsoc-gitlab-branch-source-plugin/override-hook.png[Override Hook Management]
