...
:page-layout: blog
:page-tags: azure, cloud

:page-author: clguiman
...
+
image::/images/images/post-images/2017-04-20/nsg-ssh.png[role=center]
* Allow requests to port 80 so the reverse proxy can be reached
+
image::/images/images/post-images/2017-04-20/nsg-http.png[role=center]
+
NOTE: By default, all other external traffic will be blocked
+
image::/images/images/post-images/2017-04-20/nsg-inbound.png[role=center]
...
image::/images/images/post-images/2017-04-20/auth-matrix.png[role=center,1000]
...
+
image::/images/images/post-images/2017-04-20/private-ip.png[role=center]
