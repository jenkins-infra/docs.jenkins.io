...
image::/images/images/post-images/2017-02-23/blue-ocean.png[Blue Ocean Run, role="center", width=800]

image::/images/images/post-images/2017-02-23/sauce-report.png[SauceLabs Test Report, role="center", width=800]
