...
<div><div>
 ...
 <p>For example:</p>
 <p></p>
 <p><code>//streams/bar</code> will include <code>//streams/bar</code>.</p>
 <p><code>//streams/... or //streams/* </code> will include all the streams in <code>//streams</code>.</p>
 <p><code>//streams/bar... or //streams/bar* </code> will include <code>//streams/bar, //streams/bar-01, //streams/bar-02 </code> and so on.</p>
</div></div>
