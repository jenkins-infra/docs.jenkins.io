...
This change does not affect HTTPS processing that is performed in xref:user-docs:system-administration:reverse-proxy-configuration-with-jenkins/index.adoc[reverse proxies] like Nginx and Apache HTTP Server.
