...
- id: SECURITY-2788
  ...
  description: |-
    ...
    Administrators who want to restore this functionality must set the xref:user-docs:managing:system-properties.adoc[Java system property] `hudson.plugins.testng.Publisher.allowUnescapedHTML` to `true`.
  plugins:
  - name: testng-plugin
