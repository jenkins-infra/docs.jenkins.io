...
- id: SECURITY-2559
  ...
  description: |-
    ...
    NOTE: In case of problems, the xref:user-docs:managing:system-properties.adoc[Java system property] `hudson.plugins.view.dashboard.core.IframePortlet.sandboxAttributeValue` can be used to customize the `sandbox` attribute value.
