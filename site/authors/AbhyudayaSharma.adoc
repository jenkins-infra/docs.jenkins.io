...
He is participating in Google Summer of Code 2019 to improve the performance of the link:https://github.com/jenkinsci/role-strategy-plugin[Role Strategy Plugin].