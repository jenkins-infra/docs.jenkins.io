    ...
    return (
        <IndexPageLayout>
            ...
            <section>
                ...
                <p>
                    The Jenkins project produces two release lines: Stable (LTS) and regular
                    (Weekly). Depending on your organization's needs, one may be preferred over the
                    other. See the links below for more information and recommendations about the
                    release lines.
                </p>
                <div>
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                        <div style={{ width: "50%" }}>
                            <h3>Stable (LTS)</h3>
                            <p>
                                Long-Term Support (LTS) release baselines are chosen every 12 weeks
                                from the stream of regular releases. Every 4 weeks, we release
                                stable releases which include bug and security fix backports.{" "}
                        ...
                        <div style={{ width: "50%" }}>
                            ...
                            <p>
                                This release line delivers bug fixes and new features rapidly to
                                users and plugin developers who need them. It is generally delivered
                                on a weekly cadence. <a href="/changelog-weekly"> Learn more…</a>
                            </p>
                            <p>
            ...
            <section>
                ...
                <p>
                    Jenkins is distributed as WAR files, native packages, installers, and Docker
                    images. Follow these installation steps:
                </p>
                <ol>
                    <li>
                ...
                <div className="downloadTable">
                    <div style={{ width: "45%" }}>
                        <strong>
                            <FileDownloadOutlinedIcon style={{ fontSize: "large" }} /> Download
                            Jenkins {data.site.siteMetadata.stable} LTS for:
                        </strong>
                            ...
                            <li>
                                ...
                                >
                                    <p style={{ display: "flex", alignItems: "center" }}>
                                        <span>SHA-256: {sha256Values.stable}</span>
                    ...
                    <div style={{ width: "45%" }}>
                        <strong>
                            <FileDownloadOutlinedIcon style={{ fontSize: "large" }} /> Download
                            Jenkins {data.site.siteMetadata.latest} LTS for:
                        </strong>
                        <ul className="listGroup">
                            <li>
                                <a
                                ...
                                >
                                    <p style={{ display: "flex", alignItems: "center" }}>
                                        <span>SHA-256: {sha256Values.latest}</span>
            ...
            <p>
                NOTE: Packages with the <ion-icon name="library-outline"></ion-icon> library icon
                are maintained by third parties. Such packages may not be as frequently updated as
                packages supported by the Jenkins project directly.
            </p>
            <section>
                ...
                <p style={{ marginBottom: "1cm" }}>
                    ...
                    packages. The guides provide instructions to deploy, maintain, and upgrade on
                    the specific public cloud. Such guides may be used to quickly deploy Jenkins
                    and, in many cases, to get an instance preconfigured to be used within the
                    public cloud (e.g. bundled plugins, integrations with public cloud services,
                    etc.).
                </p>
                <div>
                    <div className="vendorsList">
                        ...
                        <div className="vendors">
                            <a href="https://cloud.google.com/jenkins">
                                <img
                                    src="../../images/images/google_cloud.png"
                                    alt="GCP"
                                    width="320"
                                />
                            </a>{" "}
                        ...
                        <div className="vendors">
                            ...
                            <p>
                                Jenkins Reference Architecture and one-click deployment on Oracle
                        ...
                        <div className="vendors">
                            ...
                            <p>
                                ...
                                <a
                                    className="item"
                                    href="https://bitnami.com/stack/jenkins/cloud/aws"
                                >
                                    {" "}
                                    Amazon Web Services,
                                </a>{" "}
